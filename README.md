...
You will fill in portions of search.py and searchAgents.py during the assignment. Once you have completed the assignment, you will submit these files, together with the report generated by the autograder.py. Please do not change the other files in this distribution or submit any of our original files other than these files! See below for further submission details.

### Evaluation: 
Your code will be autograded for technical correctness. Please do not change the names of any provided functions or classes within the code, or you will wreak havoc on the autograder. However, the correctness of your implementation – not the autograder’s judgements – will be the final judge of your score. If necessary, we will review and grade assignments individually to ensure that you receive due credit for your work. Additionally, the project demo will be part of your overall score (see details below).
...
Also, all of the commands that appear in this project also appear in commands.txt, for easy copying and pasting. In Linux/Mac OS X, you can even run all these commands in order with bash commands.txt.
...
## Submission
In order to submit your project, run python autograder.py and submit the generated report to the Project 1 Submission Box on Moodle, together with your two modified files, search.py and searchAgents.py. Again, do not modify or submit any other files of the project. Only working, running code will be marked: If your project does not run with your two submitted files and the original project files, you will not receive any marks for your project!

Please read the additional details provided at the submission box carefully before handing in your group project. In particular, your group will have to include a signed Expectation of originality form (one form, signed by all group members): Your group will not receive any marks for the project until this form has been received!

Late submission: If you submit late, your project will still be accepted, but with a 10% score penalty for each day (upto 5 days maximum).

## Demo
You will have to demo your project to the TA assigned to your group (time slots for the demo will be reserved through Moodle). Note that all group members must be present for the demo and ready to answer questions about all parts of the code. That is, for each question above that your team solved, the TA will ask a random team member to explain how it works — thus, each team member has to be prepared to answer questions about the whole submitted code. If a team member cannot answer how the code for a specific question works, the whole team will receive 0 marks for this question! If a team member is not present for the demo, this member will receive 0 marks for this project assignment. Only in the case that a team member has a medical note or other valid excuse, s/he can give a separate demo of the submitted code; in this case, s/he will not receive marks for the project until this demo is completed.
